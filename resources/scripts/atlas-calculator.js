jQuery(document).ready(function ($) {  // Pass $ as parameter
    ...
    function calculatePrice() {
        ...
        try {
            ...
            let basePriceEUR = parseFloat(atlas_pricing.base_price) * blindsProfileLm;
            let totalPriceEUR = basePriceEUR;

            // Add essential components
            totalPriceEUR += uProfileLeftLm * parseFloat(atlas_pricing.price_u_profile_left || 0);
            totalPriceEUR += uProfileRightLm * parseFloat(atlas_pricing.price_u_profile_right || 0);
            totalPriceEUR += horizontalUProfileLm * parseFloat(atlas_pricing.price_u_horizontal_panel || 0);
            totalPriceEUR += reinforcingProfileLm * parseFloat(atlas_pricing.price_reinforcing_profile || 0);
            totalPriceEUR += rivetsPcs * parseFloat(atlas_pricing.price_rivets || 0);
            totalPriceEUR += selfTappingScrewPcs * parseFloat(atlas_pricing.price_self_tapping_screw || 0);
            totalPriceEUR += dowelsPcs * parseFloat(atlas_pricing.price_dowels || 0);
            totalPriceEUR += cornerPcs * parseFloat(atlas_pricing.price_corners || 0);
            ...
            if (atlas_pricing.sale_price && atlas_pricing.sale_price > 0 && atlas_pricing.sale_price < atlas_pricing.base_price) {
                discountedPriceEUR = parseFloat(atlas_pricing.sale_price) * blindsProfileLm;
                discountedPriceEUR += uProfileLeftLm * parseFloat(atlas_pricing.price_u_profile_left || 0);
                discountedPriceEUR += uProfileRightLm * parseFloat(atlas_pricing.price_u_profile_right || 0);
                discountedPriceEUR += horizontalUProfileLm * parseFloat(atlas_pricing.price_u_horizontal_panel || 0);
                discountedPriceEUR += reinforcingProfileLm * parseFloat(atlas_pricing.price_reinforcing_profile || 0);
                discountedPriceEUR += rivetsPcs * parseFloat(atlas_pricing.price_rivets || 0);
                discountedPriceEUR += selfTappingScrewPcs * parseFloat(atlas_pricing.price_self_tapping_screw || 0);
                discountedPriceEUR += dowelsPcs * parseFloat(atlas_pricing.price_dowels || 0);
                discountedPriceEUR += cornerPcs * parseFloat(atlas_pricing.price_corners || 0);
            }
            ...
            $('#atlas-final-price').html(`<p>Крайна цена: €${discountedPriceEUR.toFixed(2)} / ${discountedPriceBGN} лв.</p>`);
